...
import { updateProject } from '../../firebaseConf.js'
export default function UpdateProject(props){
    ...
    async function handleSubmit(e){
            ...
            const res = await updateProject(projectData.projectId, projectData);
            setResponse(res)
    ...
    return(
        ...
        <form onSubmit={handleSubmit} className="max-w-lg mx-auto p-10 m-10 bg-white rounded-lg">
                        <h1 className="text-center text-2xl font-bold pb-2">Update Project</h1>
                        ...
                        <div className="relative pb-1">
                            ...
                            <input value={projectData.title} onChange={handleChange} type="text" id="title" name="title" className="bg-gray-50 border border-indigo-200 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@flowbite.com"></input>
                        </div>
                      ...
                      <div className="relative pb-1">
                        ...
                        <input value={projectData.link} onChange={handleChange} type="text" id="projectLink" name="link" className="bg-gray-50 border border-indigo-200 text-gray-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full ps-10 p-2.5  dark:bg-indigo-700 dark:border-indigo-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-indigo-500" placeholder="Suggestion: ..."></input>
                      </div>

                      <label htmlFor="image" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Image Link</label>
                      <div className="relative pb-1">
                        <div className="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
                          <svg xmlns="http://www.w3.org/2000/svg"
                                 fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        ...
                        <input value={projectData.image} onChange={handleChange} type="text" id="image" name="image" className="bg-gray-50 border border-indigo-200 text-gray-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full ps-10 p-2.5  dark:bg-indigo-700 dark:border-indigo-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-indigo-500" placeholder="Suggestion: ..."></input>
                      </div>


                      <div className="flex justify-center mt-7">
                      <button type="submit" className="bg-indigo-600 rounded-lg p-1 text-white">Save Changes</button>
                      </div>
                    </form>
        </>

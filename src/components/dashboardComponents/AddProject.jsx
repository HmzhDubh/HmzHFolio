...
import { addProject } from '../../firebaseConf.js'
export default function AddProject(){
    ...
    function handleSubmit(e){
            ...
            const res = addProject(contactFormData);
            setResponse(res)
    ...
    return(
        ...
        <form onSubmit={handleSubmit} className="max-w-lg mx-auto p-10 m-10 bg-white rounded-lg">
                        <h1 className="text-center text-2xl font-bold pb-2">Add Project</h1>
                      ...
                      <div className="relative pb-1">
                        ...
                        <input onChange={handleChange} type="text" id="projectLink" name="link" className="bg-gray-50 border border-indigo-200 text-gray-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full ps-10 p-2.5  dark:bg-indigo-700 dark:border-indigo-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-indigo-500" placeholder="Suggestion: ..."></input>
                      </div>
                      ...
                      <div className="relative pb-1">
                        ...
                        <input onChange={handleChange} type="text" id="image" name="image" className="bg-gray-50 border border-indigo-200 text-gray-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full ps-10 p-2.5  dark:bg-indigo-700 dark:border-indigo-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-indigo-500" placeholder="Suggestion: ..."></input>
                      </div>
